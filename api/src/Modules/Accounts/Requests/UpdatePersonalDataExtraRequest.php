...
class UpdatePersonalDataExtraRequest extends Template
{
    public function rules(): array
    {
        return [
            ...
            'file_cert_disability' => 'nullable|mimes:pdf|max:4096',
            'have_cert_army' => 'required|boolean',
            'file_cert_army' => 'nullable|mimes:pdf|max:4096',
            'have_cert_professional_credentials' => 'required|boolean',
            'file_cert_professional_credentials' => 'nullable|mimes:pdf|max:4096',
    ...
    public function messages(): array
    {
        return [
            ...
            'genere.required' => 'El género es requerido',
            'genere.in' => 'El género debe ser 1, 2 o 3',
